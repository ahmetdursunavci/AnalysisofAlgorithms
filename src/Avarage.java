...
public class Avarage {
	...
	//in this method I generated ramdom inputs then i put them into the arrays. After that I use the sort methods by record their execution times
	public double[] avgCalculation(int a) {
